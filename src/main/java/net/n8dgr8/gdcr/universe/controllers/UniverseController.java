...
import net.n8dgr8.gdcr.universe.UniverseApplication;
import net.n8dgr8.gdcr.universe.domain.Generation;
    ...
    public ResponseEntity<String> createUniverse(@RequestBody String postContents) {
        ...
        firstGeneration.getWorld().forEach((cellId, cellState) -> {
            ...
            if (rando.nextBoolean()) {
                firstGeneration.setCellState(cellId, Generation.E_CellState.ALIVE);
            } else {
                firstGeneration.setCellState(cellId, Generation.E_CellState.DEAD);
            }
